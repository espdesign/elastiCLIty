...
#     def list_modules(self, chosenCat, dataBank):
#         if chosenCat is None:
#             return None
#         else: 
#             cats = dataBank[chosenCat]
#             print(cats)
...
class JSONBank:
    ...
    def import_category(self, argCategory):
        """
...
def main_menu():
    ...
    Databank.import_category(category_input)
...
main_menu()
# print(moduleTest.list_modules("example category", BankJSON.categories))
